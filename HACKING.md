...
hidden if the `algorithms_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `algorithms_DEVELOPER_MODE` to the configure
...
Runs the executable target `algorithms_exe`.
